...
# pass parameters into R Markdown file, in example is public health unit `phu`
set.seed(32)
phus <- c("Ottawa Public Health", "Toronto Public Health", "Peel Public Health")
phus
for (i in phus) {
  render(
    input = here("rmd", "02_param_report.rmd"),
    output_format = "html_document",
    output_file = paste0("COVID_hosp_ON_", i, "_", Sys.Date()),
